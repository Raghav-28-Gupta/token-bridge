...
contract BridgeTest is Test{
     ...
     function testDepositERC20() public {
          ...
          vm.startPrank(user);
          token._approve(address(bridge), amount);

          vm.expectEmit(true, true, true, true);
          emit Deposit(address(token), useer, user, amount, 0, SOURCE_CHAIN);
     ...
     function testDepositNativeToken() {
     ...
     function testDepositRevertsOnUnsupportedToken() public {
        ERC20 unsupportedToken = new ERC20();
